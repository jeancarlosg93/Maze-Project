...
//            }
    ...
    //Walk only one path
    //complexity of O(4^min(n×m,P)
    // where n and m represent the width and height of the maze and P represents the length of the path
    //constrained by the smallest variable
